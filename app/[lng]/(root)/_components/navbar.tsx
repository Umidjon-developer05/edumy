...
function Navbar() {
  ...
  return (
    <div
      className="sticky top-0 z-40 flex h-16 shrink-0 text-white    bg-gradient-to-r from-slate-950/90 to-slate-900/80
  backdrop-blur border-b border-white/10
    items-center gap-2 mt-3 mb-3 rounded-md mx-5 border  transition-[width,height] ease-linear sm:p-5"
    >
